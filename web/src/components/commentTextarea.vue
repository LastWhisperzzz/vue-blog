    ...
    <div class="d-flex">
      ...
      <div class="flex-1">
        ...
        <div class="mt-3 d-flex jc-between position-emoji">
          ...
          <el-button type="primary" size="small" :loading="btnLoading" @click="fabuHandle"
            >发布</el-button
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async fabuHandle() {
      ...
      this.messageObj.parent = this.type == 'children' ? this.parentId : '5ec884e3fe28d35475b43fb3'
      this.messageObj.byAiteName = this.type == 'children' ? this.nickName : 'miqilin'
